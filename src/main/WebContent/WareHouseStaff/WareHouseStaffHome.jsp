                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            <h1 class="display-1 lh-1 mb-3">WareHouseStaff <br>Home</h1>
                            <p class="lead fw-normal text-muted mb-5">Check list order and change status Order, Delivery HERE!</p>
                            <div class="d-flex flex-column flex-lg-row align-items-center">
                                <a class="me-lg-3 mb-4 mb-lg-0" href="ListOrder.jsp">
